...
export default function Nav() {
    ...
    return (
    <>
    <nav className='flex justify-around md:justify-between items-center md:px-10 px-0  py-1 md:py-2 xl:py-4 my-0 '>

<Link to={'/'} className=' w-20 2xl:w-40 md:w-56 absolute md:static left-5 top-7 xl:w-80  ' > {Logo}    </Link>
